...
fn execute_liquidate(
    ...
    */
    ...
    let collateral_from_minted: Uint128 = (debt_value / midprice_collateral_usdt)
        .to_u256()
        .try_into()
        .unwrap();
    ...
    let collateral_sent_back =
        position_data.collateral_asset.amount - collateral_from_minted - fee_liquidator_amount;
